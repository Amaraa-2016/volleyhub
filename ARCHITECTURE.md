...
## 6.1 Зургийн хадгалалт

Зураг MinIO (S3-тэй нийцтэй) дээр хадгалагдана. Volleyhub нь **өөрийн** MinIO-той — kindergarten
болон бусад бүтээгдэхүүнтэй bucket, эрх, диск юугаа ч хуваалцахгүй.

- `Service/Storage/S3FileStorage.cs` — байршуулалт кластерын **дотоод** хаягаар явна
  (`volleyhub-minio:9000`), харин буцаах URL нь **нийтийн** хаягтай. Ингэснээр ingress-ээр
  тойрч гарахгүй, гэхдээ зочны хөтөч зургийг ачаалж чадна.
- Bucket нь **нийтэд уншигдах**. Эдгээр нь мэдээний ковер, барааны зураг, сургалтын галерей —
  нэвтрээгүй зочин заавал харах ёстой контент. Pre-signed URL бол хугацаа нь дуусдаг тул
  нууц биш контентод хэрэггүй чирэгдэл болно. Бичих эрхийг зөвхөн API эзэмшинэ.
- `Controllers/MediaController.cs` — content type, өргөтгөл, 5MB хязгаарыг **энд** шалгана:
  bucket нээлттэй тул хүлээж авсан бүх зүйл дэлхийд уншигдана. Хоёр endpoint: сургалтын
  ажилтан зөвхөн өөрийн `trainings/<tenantid>/` фолдер руу, платформ админ мэдээ/бараа руу.
- DB-д **бүтэн URL** хадгалагдана. Нийтийн хаяг өөрчлөгдвөл хуучин мөрүүд хуучин host-тойгоо
  үлдэнэ — тэр үед зургийн багануудад нэг удаагийн UPDATE хийх шаардлагатай. Уншилт бүр дээр
  URL угсрахгүй байхын төлөө хийсэн сонголт.
- `Storage:*` тохиргоо хоосон бол байршуулалт л ажиллахгүй, апп хэвийн ажиллана — локал
  машинд MinIO суулгах шаардлагагүй гэсэн үг.
